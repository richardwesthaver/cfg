 ...
 *6)emptycol         */
static const char *colors[] = {"#740037","#333333","#ad5c4e","#ffafb3","#7a9933","#0c1348","#010101"};
...
static key keys[] = {
    ...
    {  MOD ,              XK_z,       resizestep_aspect, {.i=TWOBWM_RESIZE_KEEP_ASPECT_GROW}},
    {  MOD |SHIFT ,              XK_z,        resizestep_aspect, {.i=TWOBWM_RESIZE_KEEP_ASPECT_SHRINK}},
    ...
    {  MOD ,              XK_f,          fix,               {}},
    // Move the cursor
    {  MOD |SHIFT,              XK_w,         cursor_move,       {.i=TWOBWM_CURSOR_UP_SLOW}},
    ...
    {  MOD |CONTROL,        XK_d,      cursor_move,       {.i=TWOBWM_CURSOR_RIGHT}},
    {  MOD |CONTROL,        XK_a,       cursor_move,       {.i=TWOBWM_CURSOR_LEFT}},
