...
;;;; Version Control 
(defgroup default-vc ()
  "extensions for vc.el and related functionality"
  :group 'default)
...
(defcustom org-dir (expand-file-name "~/org/")
  "custom directory for user org files"
  :group 'default-org)
(defcustom log-file-format (format-time-string "%Y%m%d.org")
  "format for the org-log file"
  :group 'default-org)
(defvar org-log-dir (join-paths org-dir "log/"))
(defvar org-log-file (join-paths org-log-dir log-file-format))
(defvar org-inbox-file (join-paths org-dir "inbox.org"))
(defvar org-todo-file (join-paths org-dir "todo.org"))
(defvar org-meta-file (join-paths org-dir "metas.org"))
(defvar org-notes-file (join-paths org-dir "notes.org"))
(defvar org-ramble-file (join-paths org-dir "ramble.org"))
(defvar org-archive-file (join-paths org-dir "archive.org::"))
(defvar org-babel-dir (join-paths org-dir "babel/"))
(defvar org-notes-dir (join-paths org-dir "notes/"))
(defvar org-cache-dir (join-paths org-dir "cache/"))
...
(setq org-startup-indented t
      ...
      org-columns-default-format "%TIMESTAMP %25ITEM %TODO %3PRIORITY %10EFFORT %10CLOCKSUM"
      org-default-notes-file 'org-log-file
      org-archive-location org-archive-file
      org-agenda-files (directory-files-recursively org-dir "\.org$" nil t)
      org-log-done 'note
...
(org-babel-do-load-languages
 'org-babel-load-languages '((C . t) ;also handles cpp
			     (shell . t)
			     (lua . t)
			     (makefile . t)
			     (haskell . t)
...
(setq org-todo-keywords
      '((sequence "TODO(t@)" "RESEARCH(r@)" "HACK(h@)" "CONSUME(x@)" "GOTO(g@/!)" "NEXT(n@)" "|" "DONE(d@/!)" "KILL(k@/!)")))

;;;;; org-id
(setq org-id-link-to-org-use-id t)
;;;###autoload
(defun org-custom-id-get (&optional pom create)
...
;;;###autoload
(defun org-add-custom-ids-to-headlines-in-file ()
